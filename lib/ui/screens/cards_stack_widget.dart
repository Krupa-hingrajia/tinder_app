...
class _CardsStackWidgetState extends State<CardsStackWidget> with SingleTickerProviderStateMixin {
  ...
  List<Profile> draggableItems = [
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_1.jpeg'),
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_2.jpeg'),
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_3.jpeg'),
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_4.jpeg'),
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_5.jpeg'),
    const Profile(name: 'Rohini', distance: '10 miles away', imageAsset: 'assets/image/images_6.jpeg'),
  ];
                          ...
                          child: RotationTransition(
                            ...
                            child: DragWidget(
                              ...
                              onPressed: () {
                                ...
                                print('_______________________________${userId}');
                              },
                              icon: const Icon(
                                Icons.favorite,
                                color: Colors.red,
